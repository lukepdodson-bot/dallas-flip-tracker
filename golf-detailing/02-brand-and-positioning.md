...
- **Category:** Premium, club-partnered mobile auto detailing.
- **Not:** A discount car wash. A random guy in the lot. A "we'll fit you in someday"
  mobile detailer.
...
|------|--------------|------------|
| **Fairway Detail Co.** ⭐ *(working name)* | Instantly reads as golf + detailing, professional, geography-neutral so it scales beyond Dallas. Clean logo potential. | Common word "fairway" — confirm URL/trademark availability. |
| **The Turn Detailing** | "The turn" = the break between the front and back nine. Insider golf term that *is* the pitch: your car gets done mid-round. Memorable, ownable. | Slightly less obvious to non-golfers (but our customer golfs). |
| **Back Nine Detail Co.** | Golf-native, energetic, easy to say. | Less descriptive of what we do. |
| **Caddie Auto Detail** | Evokes "someone handles it for you while you play." Strong service metaphor. | "Caddie/Caddy" is heavily used; trademark check essential. |
| **Divot & Shine** | Distinctive, boutique feel. | Cute over clear; weaker for cold club outreach. |

**Recommendation:** Launch as **Fairway Detail Co.** — clearest to a GM reading a cold
email, scales past Dallas, easy logo. Keep **The Turn Detailing** as the strong runner-up
if URL/trademark for Fairway is taken.
...
## Visual direction (for logo/site, low-cost)
...
## Brand rules that protect the club relationship

These are as much sales tools as brand rules:
- Uniformed, background-checked, insured technicians.
- Clean, quiet, self-contained rig — no eyesore, no mess, no runoff on turf.
- We present as *the club's* amenity in member-facing materials, co-branded where the
  club wants it.

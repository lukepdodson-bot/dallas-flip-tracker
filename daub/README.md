...
*To daub is to lay paint on a surface. The product is the bit in between: a
photographer's image, a painter's hand, and cleared rights joining them.*
...
Demo accounts, seeded on an empty database — password `DaubDemo2026!`:
